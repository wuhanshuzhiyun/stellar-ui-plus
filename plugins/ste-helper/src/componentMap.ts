...
export const componentMap: Record<string, ComponentDesc> = {
    ...
    "function-list": {
        ...
        "props": [
            ...
            {
                "name": "[slot]subhead",
                "description": "组件头部副标题插槽（若副标题有表情/图片等，请使用插槽）"
            },
            {
                "name": "[slot]header-right",
                "description": "组件头部右侧插槽（替换右侧`更多`）"
            }
        ],
        "events": [
            {
    ...
    "goods-info": {
        ...
        "props": [
            ...
            {
                "name": "[slot]default",
                "description": "默认插槽，在编码下方出现的其他内容"
            },
            {
                "name": "[slot]stepper",
                "description": "步进器位置插槽，使用该插槽后将替换掉步进器"
            }
        ],
        "events": [
            {
    ...
    "message-box": {
        ...
        "props": [
            ...
            {
                "name": "icon",
                "description": "提示区域显示图标，此时content会失效",
                "type": "String",
                "default": ""
            },
            {
            ...
            {
                "name": "cancelColor",
                "description": "取消按钮的文字颜色",
                "type": "String",
                "default": "#333333"
            },
            {
                "name": "confirmText",
                "description": "确认按钮的文字，最多4个字符",
                "type": "String",
                "default": "确认"
            },
            {
                "name": "confirmColor",
                "description": "确认按钮的文字颜色",
                "type": "String",
                "default": "#0090FF"
            },
            {
            ...
            },
            {
                ...
                "description": "显示输入框时的提示文本",
                "type": "String",
                "default": ""
            },
            {
                "name": "confirm",
                "description": "点击确认的回调函数",
                "type": "Function",
                "default": null
            },
            {
            ...
            {
                "name": "complete",
                "description": "弹框关闭的回调函数（无论是确认关闭还是取消关闭）",
                "type": "Function",
                "default": null
            }
        ],
    ...
    "qrcode": {
        ...
        "props": [
            ...
            {
                "name": "foregroundImageSrc",
                "description": "二维码中间logo图",
                "type": "string"
            },
            {
                "name": "foregroundImageWidth",
                "description": "logo图宽度，默认二维码尺寸的四分之一",
                "type": "string",
                "default": "size / 4"
            },
            {
                "name": "foregroundImageHeight",
                "description": "logo图高度，默认二维码尺寸的四分之一",
                "type": "string",
                "default": "size / 4"
            }
        ],
