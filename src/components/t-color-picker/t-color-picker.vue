<template>
    <view v-show="show" class="t-wrapper" @touchmove.stop.prevent="moveHandle" @mousemove.stop.prevent="moveHandle">
        ...
        <view class="t-box" :class="{ active: active }">
            ...
            <view class="t-control__box">
                ...
                <view class="t-control-box__item">
                    ...
                    <view
                        ...
                        @mousedown="touchstart($event, 2)"
                        @mousemove="touchmove($event, 2)"
            ...
            <view class="t-alternative">
                <view class="t-alternative__item" v-for="(item, index) in colorList" :key="index">
                    <view class="t-alternative__item-content" :style="{ background: 'rgba(' + item.r + ',' + item.g + ',' + item.b + ',' + item.a + ')' }" @click="selectColor(item)"></view>
                </view>
            </view>
        </view>
    </view>
