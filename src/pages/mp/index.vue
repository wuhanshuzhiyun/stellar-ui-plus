...
import config from '@/stellar-plus/package.json';
          ...
          <view class="components-content">
            <view v-for="(m, i) in item.contents" :key="i" class="components-item" @click="toDemo(m)">
              <view class="item-title">
                <image :src="m.icon" mode="widthFix" />
                <text>{{ m.name }}</text>
              </view>
              <view class="item-icon">
                <image
                  class="icon-image"
                  src="https://image.whzb.com/chain/StellarUI/%E7%BB%84%E4%BB%B6%E5%9B%BE%E6%A0%87/r-arrow.png"
                />
              </view>
            </view>
          </view>
