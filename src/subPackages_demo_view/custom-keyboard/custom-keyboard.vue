...
<template>
    <page-layout title="数字键盘">
        <view class="description">
            <view class="cmp-name">CustomKeyboard 定制键盘</view>
            <view class="cmp-desc">虚拟键盘，用于快捷输入折扣、身份证等场景。</view>
        </view>
        <view class="demo-item">
            <view class="title">基础用法（数字键盘）</view>
        ...
        <view class="demo-item">
            <view class="title">基础用法（身份证）</view>
            <view class="test-input" @click="show4 = true">
                <text v-if="value4">{{ value4 }}</text>
                <text v-else class="placeholder">请输入</text>
            </view>
            <ste-custom-keyboard type="idcard" v-model="value4" v-model:show="show4" />
        </view>
        <view class="demo-item">
            <view class="title">基础用法（折扣）</view>
            <view class="test-input" @click="show8 = true">
        ...
        <view class="demo-item">
            ...
            <ste-custom-keyboard :rightKeys="false" v-model="value2" v-model:show="show2" />
        </view>
        <view class="demo-item">
            ...
            <ste-custom-keyboard :showClear="false" v-model="value3" v-model:show="show3" maxlength="6" />
        </view>
        <view class="demo-item">
            ...
            <ste-custom-keyboard v-model="value5" v-model:show="show5" textColor="#f00" textSize="40" confirmBg="#f00" confirmColor="#0f0" confirmText="完成" />
        </view>
        <view class="demo-item">
            ...
            <ste-custom-keyboard :customKeys="['返回']" v-model="value6" v-model:show="show6" @beforeinput="beforeinput" />
        </view>
        <view class="demo-item">
            ...
            <view style="padding: 30rpx; background-color: #f5f5f5; margin-top: 12rpx">
                <ste-custom-keyboard mode="page" v-model="value7" />
            </view>
        </view>
        <view class="demo-item">
            ...
            <view style="padding: 30rpx; background-color: #f5f5f5; margin-top: 12rpx">
                <ste-custom-keyboard mode="page" :inputValues="inputValues" :activeInputRef="activeInputRef" :rightKeys="false" />
            </view>
        </view>
    </page-layout>
</template>
