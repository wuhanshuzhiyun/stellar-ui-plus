...
<template>
    <page-layout title="主信息展示" contentStyle="background: #F2F3F5;">
        <view class="description">
            <view class="cmp-name">MainInfo 主信息展示</view>
            <view class="cmp-desc">用于展示一些主要信息</view>
        </view>
        ...
        <view class="demo-item">
            <view class="title">2数据&有核销码</view>
            <view class="item-block">
                <view style="width: 100%">
        ...
        <view class="demo-item">
            <view class="title">3数据&无核销码</view>
            <view class="item-block">
                <view style="width: 100%">
        ...
        <view class="demo-item">
            <view class="title">无头像名称&有3个数据&有核销码</view>
            <view class="item-block">
                <view style="width: 100%">
        ...
        <view class="demo-item">
            <view class="title">无头像名称&有3个数据&无核销码</view>
            <view class="item-block">
                <view style="width: 100%">
