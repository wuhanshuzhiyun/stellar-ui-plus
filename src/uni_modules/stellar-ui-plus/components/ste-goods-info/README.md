...
<template>
    <ste-button @click="show = true">默认(单个日期)</ste-button>
...
<template>
    <ste-button @click="show = true">多个日期</ste-button>
    <ste-popup v-model:show="show" height="60vh" position="bottom">
        <div style="padding-bottom: 20px; height: 100%">
...
<template>
    <ste-button @click="show = true">日期范围</ste-button>
    <ste-popup v-model:show="show" height="60vh" position="bottom">
        <div style="padding-bottom: 20px; height: 100%">
...
<template>
    <ste-button @click="show = true">自定义主题色</ste-button>
    <ste-popup v-model:show="show" height="60vh" position="bottom">
        <div style="padding-bottom: 20px; height: 100%">
...
<template>
    <ste-button @click="show = true">自定义文案</ste-button>
    <ste-popup v-model:show="show" height="60vh" position="bottom">
        <div style="padding-bottom: 20px; height: 100%">
...
<template>
    <ste-button @click="show = true">多选数量限制</ste-button>
    <ste-popup v-model:show="show" height="60vh" position="bottom">
        <div style="padding-bottom: 20px; height: 100%">
...
<template>
    <ste-button @click="show = true">范围数量限制</ste-button>
    <ste-popup v-model:show="show" height="60vh" position="bottom">
        <div style="padding-bottom: 20px; height: 100%">
...
<template>
    <ste-button @click="show = true">默认选择日期</ste-button>
    <ste-popup v-model:show="show" height="60vh" position="bottom">
        <div style="padding-bottom: 20px; height: 100%">
...
<template>
    <ste-button @click="show = true">默认展示月份</ste-button>
    <ste-popup v-model:show="show" position="bottom" height="60vh" @open-after="setViewMonth">
        <div style="padding-bottom: 20px; height: 100%">
...
<template>
    <ste-button @click="show = true">隐藏确定按钮</ste-button>
    <ste-popup v-model:show="show" position="bottom" height="60vh">
        <div style="padding-bottom: 20px; height: 100%">
...
<template>
    <ste-button @click="show = true">只读</ste-button>
    <ste-popup v-model:show="show" position="bottom" height="60vh">
        <div style="padding-bottom: 20px; height: 100%">
...
<template>
    <ste-button @click="show = true">隐藏背景月份</ste-button>
    <ste-popup v-model:show="show" position="bottom" height="60vh">
        <div style="padding-bottom: 20px; height: 100%">
